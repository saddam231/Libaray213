  ...
  return (
    ...
    <thead>
      <tr>
        ...
        <th className="border border-slate-600 rounded-md" >BooksName</th>
    ...
    <tbody>
      {books.map((book, index) => (
          <tr key={book._id} className="h-8">
            ...
            <td className="border border-slate-600 rounded-md text-center" >{book.booksname}</td>
            ...
            <td className="border border-slate-600 rounded-md text-center" >
              <div className="flex justify-center gap-x-4">
                ...
                <Link to={`/books/edit/${book._id}`}>
                  <AiOutlineEdit className="text-2xl text-text-yellow-800" />
                  </Link>
